...
$name1 = $name.Name
  ...
  try{
              ...
              {
               Remove-ADGroupMember -Identity $Groupname -Members $name1 -Confirm:$false 
               Write-Host "Removed User Sucessfully " $name1 -ForegroundColor Cyan
